      ...
      <div className="mb-10">
        ...
        <div className="relative max-w-2xl">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition-shadow"
          />
        </div>
      </div>

      {error && (
        <div className="p-4 bg-red-50 text-red-700 rounded-xl border border-red-200 mb-6 font-medium">
          {error}
        </div>
      )}
